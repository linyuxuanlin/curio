...
function bindDrag(card) {
 ...
 card.addEventListener('pointerup',e=>end(e)); card.addEventListener('pointercancel',e=>end(e,true)); card.addEventListener('lostpointercapture',e=>end(e,true)); card.addEventListener('touchmove',e=>{if(drag?.locked)e.preventDefault();},{passive:false});
}
